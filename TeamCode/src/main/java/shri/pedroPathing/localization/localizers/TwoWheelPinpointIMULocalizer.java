...
import shri.pedroPathing.localization.GoBildaPinpointDriver;
 ...
 * @author Baron Henderson - 20077 The shri
...
public class TwoWheelPinpointIMULocalizer extends Localizer {
    ...
    public TwoWheelPinpointIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(7.5 - 6.25, 12.5 - 11.25, 0);
        strafeEncoderPose = new Pose(7.5 - 6.25, -12.5 + 11.25, Math.toRadians(90));
